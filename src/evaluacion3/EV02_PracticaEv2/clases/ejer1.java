...
public class ejer1 {
    ...
    public static void main(String[] args) {
        ...
        File entrada = new File("src/evaluacion3/EV02_PracticaEv2/ficheros/entrada1.txt");
        try {
            leer(entrada);
        } catch (IOException e) {
    ...
    private static void escribir(int x, String s, ArrayList<String> lineas) throws IOException {
        FileWriter salida = new FileWriter("src/evaluacion3/EV02_PracticaEv2/ficheros/salida1.txt");
